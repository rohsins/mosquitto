...
def do_test():
    ...
    publish_packet_in = mqtt_packets.gen_publish("retain-handling", qos=0, payload="m", proto_ver=5, properties=props)
    publish_packet_out = mqtt_packets.gen_publish("retain-handling", qos=0, payload="m", proto_ver=5)
