...
def do_test(conn, data):
    ...
    mid = 1
    publish_1_packet = mqtt_packets.gen_publish("topic", qos=2, mid=mid, payload="12345", proto_ver=5)
    pubrec_1_packet = mqtt_packets.gen_pubrec(mid, proto_ver=5)
    pubrel_1_packet = mqtt_packets.gen_pubrel(mid, proto_ver=5)
    pubcomp_1_packet = mqtt_packets.gen_pubcomp(mid, proto_ver=5)

    mid = 2
    publish_2_packet = mqtt_packets.gen_publish("topic", qos=2, mid=mid, payload="12345", proto_ver=5)
    ...
    mid = 3
    publish_3_packet = mqtt_packets.gen_publish("topic", qos=2, mid=mid, payload="12345", proto_ver=5)
    pubrec_3_packet = mqtt_packets.gen_pubrec(mid, proto_ver=5)
    pubrel_3_packet = mqtt_packets.gen_pubrel(mid, proto_ver=5)
    pubcomp_3_packet = mqtt_packets.gen_pubcomp(mid, proto_ver=5)

    mid = 4
    publish_4_packet = mqtt_packets.gen_publish("topic", qos=2, mid=mid, payload="12345", proto_ver=5)
    pubrec_4_packet = mqtt_packets.gen_pubrec(mid, proto_ver=5)
    pubrel_4_packet = mqtt_packets.gen_pubrel(mid, proto_ver=5)
    pubcomp_4_packet = mqtt_packets.gen_pubcomp(mid, proto_ver=5)

    mid = 5
    publish_5_packet = mqtt_packets.gen_publish("topic", qos=2, mid=mid, payload="12345", proto_ver=5)
    pubrec_5_packet = mqtt_packets.gen_pubrec(mid, proto_ver=5)
    pubrel_5_packet = mqtt_packets.gen_pubrel(mid, proto_ver=5)
    pubcomp_5_packet = mqtt_packets.gen_pubcomp(mid, proto_ver=5)
