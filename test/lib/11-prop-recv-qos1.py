...
def do_test(conn, data):
    ...
    publish_packet = mqtt_packets.gen_publish("prop/test", mid=mid, qos=1, payload="message", proto_ver=5, properties=props)
    puback_packet = mqtt_packets.gen_puback(mid=mid, proto_ver=5)
